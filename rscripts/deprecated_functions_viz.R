# Graveyard for previous visualization functions

#
#comparisons between groups

#makes a diverging lollipop chart using ggcharts
#ggcharts proved harder to tinker with than just building it out oneself- labeling points
