...
#### Faculty behaviors in class

A battery of questions asks students to consider their experiences with faculty in courses. Responses to these questions were generally positive, and had low variation by student group (within 1 or 2 percentage points of the student body average). Therefore, we only show the student body average for each of the questions.
...
gt_fac_behav_list_2022<- fac_behav_list_2022%>%
  ...
  ungroup(.)%>%
  gt(rowname_col = "q")%>%
  tab_header(title="How often have you experienced the following?",
            subtitle="UCUES 2022")%>%
  cols_align(
    align="left",
    columns=q
...
For more on what undergraduate research looks like on campus - see the Undergraduate Research Hub's [Research Directory](https://ugresearch.ucsd.edu/students/research-directory.html), job postings on REAL, and the Design Lab's 
...
Participating in academic service or community-based learning experiences is overall much less common than research. Notably, African American students have the highest rate of participation, at 31%.  
...
Finally, about 57% of undergraduates report having participated in an internship, practicum, or field experience, although that range varies by student group, from 45% of transfer students to 64% of First-Time First Year students and not First Generation students. 
...
plot_group_comp(internship_2022, cols_pos)%>%
  plot_diff_rect(.,internship_2022, .44,.7,"Less participation", "More participation")+
