...
plot_group_comp(fac_name_2022, cols_neg)%>%
  plot_diff_rect(., fac_name_2022, .52,.79,"Fewer professors didn't know name", "More unknown")+
  labs(title="Had a class in which the professor knew or learned your name",
         caption=caption_ug,
      subtitle = "Percent of UCSD UG who occasionally, rarely, or never had a class \nwhere professor knew their name")
