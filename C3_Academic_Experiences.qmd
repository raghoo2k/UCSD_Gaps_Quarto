...
####How often have you: increased your academic effort due to the high standards of a faculty member
...
plot_group_comp(any_hip_2022, cols_neg)%>%
  plot_diff_rect(.,any_hip_2022, .20,.38,"Less non-participation", "More non-participation")+
  labs(title="Never participated in a research activity, a creative project, an internship or\nacademic service learning at UCSD",
         caption=caption_ug,
...
plot_group_comp(research_2022, cols_neg)%>%
  plot_diff_rect(.,research_2022, .34,.62,"Less non-participation", "More non-participation")+
  labs(title="Never participated in a research activity or a creative project at UCSD",
         caption=caption_ug,
      subtitle = "UCSD UG never participated, near graduation")
...
plot_group_comp(service_2022, cols_neg)%>%
  plot_diff_rect(.,service_2022, .68,.89,"Less non-participation", "More non-participation")+
  labs(title="Never participated in an academic service or community-based learning experience ",
         caption=caption_ug,
      subtitle = "UCSD UG never participated, near graduation")
...
plot_group_comp(internship_2022, cols_neg)%>%
  ...
  labs(title="Never participated in an ainternship, practicum, or field experience ",
         caption=caption_ug,
      subtitle = "UCSD UG never participated, near graduation")
