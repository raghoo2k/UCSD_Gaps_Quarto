...
As of Fall 2022, the following visual describes the percentage of UCSD students in each group, including groups whose UCUES responses are not publicly available (sexual orientation) and not included in this analysis at this time (CA residency). This visual is available for more interactive exploration at the [UC Infocenter](https://www.universityofcalifornia.edu/about-us/information-center/fall-enrollment-glance). Up to date UCSD specific student counts can be found at UCSD IR [3rd Week Enrollment Dashboard](https://ir.ucsd.edu/third-week/)

[![UCSD Undergraduate Population 2022](viz/intro/UCSD_UG_demo.png)](https://www.universityofcalifornia.edu/about-us/information-center/fall-enrollment-glance) UCSD Undergraduate Population 2022
...
### UC San Diego GradSERU {#sec-gradseru} 

UC San Diego administered the Graduate Student Experience in the Research University (gradSERU) in 2019 and 2021. This survey is administered to a range of universities beyond the UC system, providing additional campus results for comparison when appropriate. While UC San Diego appears to no longer be running this survey, opting for UCGSES, both UCGSES and gradSERU were administered in 2021, with gradSERU eliciting a higher response count, 2,262 students versus about 1047 respondents to UCGSES. Click here for more on [UC San Diego gradSERU](https://ir.ucsd.edu/grad/surveys/gradseru/gradseru-results2021.html)
