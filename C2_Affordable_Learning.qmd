...
This is a chapter about affordable learning and financial support at University of California San Diego. The first two sections focus on undergraduate and graduate student survey responses, respectively. The third section explores results from a one-time survye of undergraduate students on their experiences with buying course materials. 
...
food_secure_time_wide<-clean_wide_time(food_secure_time)
 ...
 plot_time_dumbell(food_secure_time_wide)+
   ...
   ggsave("viz/afls/food_insecure_time.png", width=9, height=5.5, units="in", dpi=300)
...
collapse_negative_vibe(.)%>%
 ...
 ggsave("viz/afls/food_insecure_2022.png", width=9, height=5.5, units="in", dpi=300)
...
plot_group_comp(payhousing_2022, cols_neg)%>%
 ...
 ggsave("viz/afls/payhousing_2022.png", width=9, height=5.5, units="in", dpi=300)
...
collapse_negative_vibe(.)%>%
 ...
 ggsave("viz/afls/worried_housing_2022.png", width=9, height=5.5, units="in", dpi=300)
...
plot_group_comp(worried_debt_2022, cols_neg)%>%
 ...
 ggsave("viz/afls/worried_debt_2022.png", width=9, height=5.5, units="in", dpi=300)
```
...
group_by(campus,year, vibe)%>%
 ...
 g_manage_time<-plot_time_dumbell(manage_ug_time_wide)+
  ...
  move_layers(g_manage_time,"GeomSegment", position="bottom")
   ...
   ggsave("viz/afls/manageable_time.png", width=9, height=5.5, units="in", dpi=300)
```
...
plot_group_comp(manageable_2022, cols_neg)%>%
 ...
 ggsave("viz/afls/manage_2022.png", width=9, height=5.5, units="in", dpi=300)
```
...
plot_time_dumbell(food_grad_wide)+
 ...
 ggsave("viz/afls/food_insecure_grad_time.png", width=9, height=5.5, units="in", dpi=300)
...
ggsave("viz/afls/food_insecure_grad.png", width=9, height=5.5, units="in", dpi=300)
...
ggsave("viz/afls/hardship_grad.png", width=9, height=5.5, units="in", dpi=300)
```
...
ggsave("viz/afls/concerned_grad.png", width=9, height=5.5, units="in", dpi=300) 
...
ggsave("viz/afls/confident_grad.png", width=9, height=5.5, units="in", dpi=300) 
...
ggsave("viz/afls/getby_grad.png", width=9, height=5.5, units="in", dpi=300) 
