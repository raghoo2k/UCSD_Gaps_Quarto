...
food_secure_time_wide<-clean_wide_time(food_secure_time)
 ...
 plot_time_dumbell(food_secure_time_wide)+
   ...
   ggsave("viz/food_insecure_time.png", width=9, height=5.5, units="in", dpi=300)
...
collapse_negative_vibe(.)%>%
 ...
 ggsave("viz/food_insecure_2022.png", width=9, height=5.5, units="in", dpi=300)
...
plot_group_comp(payhousing_2022, cols_neg)%>%
 ...
 ggsave("viz/payhousing_2022.png", width=9, height=5.5, units="in", dpi=300)
...
collapse_negative_vibe(.)%>%
 ...
 ggsave("viz/worried_housing_2022.png", width=9, height=5.5, units="in", dpi=300)
...
plot_group_comp(worried_debt_2022, cols_neg)%>%
 ...
 ggsave("viz/worried_debt_2022.png", width=9, height=5.5, units="in", dpi=300)
```
...
group_by(campus,year, vibe)%>%
 ...
 g_manage_time<-plot_time_dumbell(manage_ug_time_wide)+
  ...
  move_layers(g_manage_time,"GeomSegment", position="bottom")
   ...
   ggsave("viz/manageable_time.png", width=9, height=5.5, units="in", dpi=300)
```
...
plot_group_comp(manageable_2022, cols_neg)%>%
 ...
 ggsave("viz/manage_2022.png", width=9, height=5.5, units="in", dpi=300)
```
...
plot_time_dumbell(food_grad_wide)+
 ...
 ggsave("viz/food_insecure_grad_time.png", width=9, height=5.5, units="in", dpi=300)
...
ggsave("viz/food_insecure_grad.png", width=9, height=5.5, units="in", dpi=300)
...
ggsave("viz/hardship_grad.png", width=9, height=5.5, units="in", dpi=300)
```
...
ggsave("viz/concerned_grad.png", width=9, height=5.5, units="in", dpi=300) 
...
ggsave("viz/confident_grad.png", width=9, height=5.5, units="in", dpi=300) 
...
ggsave("viz/getby_grad.png", width=9, height=5.5, units="in", dpi=300) 
