...
This chapter continues be updated and edited with additional interpretation and student groups - most recent updates 3/21/22. 
...
plot_group_comp(opp_research_ment_2021, cols_neg)%>%
  plot_diff_rect(., opp_research_ment_2021,.13,.4, "Fewer Low Ratings", "More Low Ratings")+
...
### Opportunities to form non-research/academic mentorship relationships with faculty members
```{r}
#| label: opp_ment
#| echo: FALSE
#| warning: FALSE
...
plot_group_comp(career_sup_2021, cols_neg)%>%
  plot_diff_rect(., career_sup_2021,.08,.35, "Fewer Dissatisfied", "More Dissatisfied")+
